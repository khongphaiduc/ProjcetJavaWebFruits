...
<body>
    ...
    <script>
        ...
        const revenueChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: ['Ngày 1', 'Ngày 2', 'Ngày 3', 'Ngày 4','Ngày 5','Hôm Nay'],
                datasets: [{
                        label: 'Doanh Thu (VND)',
                        data: [${listProfix.get(0)},${listProfix.get(1)},${listProfix.get(2)},${listProfix.get(3)},${listProfix.get(4)},${listProfix.get(5)}],
